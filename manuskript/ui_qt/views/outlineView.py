...
from manuskript.ui_qt.views.dndView import dndView
from manuskript.ui_qt.views.outlineBasics import outlineBasics
from manuskript.ui_qt.views.outlineDelegates import outlineTitleDelegate, outlineCharacterDelegate, outlineCompileDelegate, \
