...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.pageAIFeatures = QtWidgets.QWidget()
        self.pageAIFeatures.setObjectName("pageAIFeatures")
        self.verticalLayout_ai = QtWidgets.QVBoxLayout(self.pageAIFeatures)
        self.verticalLayout_ai.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_ai.setObjectName("verticalLayout_ai")
        self.lblTitleAIFeatures = QtWidgets.QLabel(self.pageAIFeatures)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblTitleAIFeatures.sizePolicy().hasHeightForWidth())
        self.lblTitleAIFeatures.setSizePolicy(sizePolicy)
        self.lblTitleAIFeatures.setAlignment(QtCore.Qt.AlignCenter)
        self.lblTitleAIFeatures.setObjectName("lblTitleAIFeatures")
        self.verticalLayout_ai.addWidget(self.lblTitleAIFeatures)
        
        # API Key Section
        self.groupBoxAPIKey = QtWidgets.QGroupBox(self.pageAIFeatures)
        font = QtGui.QFont()
        font.setBold(True)
        self.groupBoxAPIKey.setFont(font)
        self.groupBoxAPIKey.setObjectName("groupBoxAPIKey")
        self.formLayout_api = QtWidgets.QFormLayout(self.groupBoxAPIKey)
        self.formLayout_api.setObjectName("formLayout_api")
        
        self.lblClaudeAPIKey = QtWidgets.QLabel(self.groupBoxAPIKey)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblClaudeAPIKey.setFont(font)
        self.lblClaudeAPIKey.setObjectName("lblClaudeAPIKey")
        self.formLayout_api.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.lblClaudeAPIKey)
        
        self.txtClaudeAPIKey = QtWidgets.QLineEdit(self.groupBoxAPIKey)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtClaudeAPIKey.setFont(font)
        self.txtClaudeAPIKey.setEchoMode(QtWidgets.QLineEdit.Password)
        self.txtClaudeAPIKey.setObjectName("txtClaudeAPIKey")
        self.formLayout_api.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.txtClaudeAPIKey)
        
        self.verticalLayout_ai.addWidget(self.groupBoxAPIKey)
        
        # AI Features Section
        self.groupBoxAIFeatures = QtWidgets.QGroupBox(self.pageAIFeatures)
        font = QtGui.QFont()
        font.setBold(True)
        self.groupBoxAIFeatures.setFont(font)
        self.groupBoxAIFeatures.setObjectName("groupBoxAIFeatures")
        self.formLayout_features = QtWidgets.QFormLayout(self.groupBoxAIFeatures)
        self.formLayout_features.setObjectName("formLayout_features")
        
        # Narrative Graph Memory
        self.lblNarrativeGraph = QtWidgets.QLabel(self.groupBoxAIFeatures)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblNarrativeGraph.setFont(font)
        self.lblNarrativeGraph.setObjectName("lblNarrativeGraph")
        self.formLayout_features.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.lblNarrativeGraph)
        
        self.chkNarrativeGraph = QtWidgets.QCheckBox(self.groupBoxAIFeatures)
        font = QtGui.QFont()
        font.setBold(False)
        self.chkNarrativeGraph.setFont(font)
        self.chkNarrativeGraph.setObjectName("chkNarrativeGraph")
        self.formLayout_features.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.chkNarrativeGraph)
        
        # Adaptive Voice & Style Mirror
        self.lblAdaptiveVoice = QtWidgets.QLabel(self.groupBoxAIFeatures)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblAdaptiveVoice.setFont(font)
        self.lblAdaptiveVoice.setObjectName("lblAdaptiveVoice")
        self.formLayout_features.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lblAdaptiveVoice)
        
        self.chkAdaptiveVoice = QtWidgets.QCheckBox(self.groupBoxAIFeatures)
        font = QtGui.QFont()
        font.setBold(False)
        self.chkAdaptiveVoice.setFont(font)
        self.chkAdaptiveVoice.setObjectName("chkAdaptiveVoice")
        self.formLayout_features.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.chkAdaptiveVoice)
        
        # Placeholder for future features
        self.line_ai = QtWidgets.QFrame(self.groupBoxAIFeatures)
        self.line_ai.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_ai.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_ai.setObjectName("line_ai")
        self.formLayout_features.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.line_ai)
        
        self.lblMoreFeatures = QtWidgets.QLabel(self.groupBoxAIFeatures)
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(True)
        self.lblMoreFeatures.setFont(font)
        self.lblMoreFeatures.setAlignment(QtCore.Qt.AlignCenter)
        self.lblMoreFeatures.setObjectName("lblMoreFeatures")
        self.formLayout_features.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.lblMoreFeatures)
        
        self.verticalLayout_ai.addWidget(self.groupBoxAIFeatures)
        
        # Add spacer to push everything to the top
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_ai.addItem(spacerItem)
        
        self.stack.addWidget(self.pageAIFeatures)
    ...
    def retranslateUi(self, Settings):
        ...
        item.setText(_translate("Settings", "AI Features"))
...
" to words"))
        ...
        self.lblTitleAIFeatures.setText(_translate("Settings", "AI Features"))
        self.groupBoxAPIKey.setTitle(_translate("Settings", "API Configuration"))
        self.lblClaudeAPIKey.setText(_translate("Settings", "Claude API Key:"))
        self.groupBoxAIFeatures.setTitle(_translate("Settings", "AI Features"))
        self.lblNarrativeGraph.setText(_translate("Settings", "Narrative Graph Memory:"))
        self.chkNarrativeGraph.setText(_translate("Settings", "Enable"))
        self.lblAdaptiveVoice.setText(_translate("Settings", "Adaptive Voice & Style Mirror:"))
        self.chkAdaptiveVoice.setText(_translate("Settings", "Enable"))
        self.lblMoreFeatures.setText(_translate("Settings", "More AI features coming soon..."))
