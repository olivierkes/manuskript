...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.chkCountCharMode = QtWidgets.QCheckBox(self.horizontalGroupBox)
        font = QtGui.QFont()
        font.setBold(False)
        self.chkCountCharMode.setFont(font)
        self.chkCountCharMode.setObjectName("chkCountCharMode")
        self.horizontalLayout_13.addWidget(self.chkCountCharMode)
...
" to words"))
        ...
        self.chkCountCharMode.setText(_translate("Settings", "Counting by characters"))
