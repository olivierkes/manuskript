...
#
# Created by: PyQt5/6 UI code generator 5.15.11
#
...
class Ui_targets(object):
    def setupUi(self, targets):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("manuskript/ui/tools/../../../../../../../../../../home/icons/Manuskript/icon-64px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
